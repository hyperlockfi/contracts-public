...
contract RewardFactory {
    ...
    address public immutable baseRewardPoolImpl;
    address public immutable virtualBalanceRewardPoolImpl;
     ...
     * @param _baseRewardPoolImpl           BaseRewardPool implementation contract
     * @param _virtualBalanceRewardPoolImpl VirtualBalanceRewardPool implementation contract
     */
    constructor(
        address _operator,
        address _crv,
        address _baseRewardPoolImpl,
        address _virtualBalanceRewardPoolImpl
    ) public {
        operator = _operator;
        crv = _crv;
        baseRewardPoolImpl = _baseRewardPoolImpl;
    ...
    function CreateCrvRewards(
        ...
        BaseRewardPool4626 rewardPool = BaseRewardPool4626(Clones.clone(baseRewardPoolImpl));
        rewardPool.init(_pid, _depositToken, crv, address(this), _lptoken);
    ...
    function CreateTokenRewards(
        ...
        VirtualBalanceRewardPool rewardPool = VirtualBalanceRewardPool(Clones.clone(virtualBalanceRewardPoolImpl));
        rewardPool.init(_mainRewards, _token, _operator);
