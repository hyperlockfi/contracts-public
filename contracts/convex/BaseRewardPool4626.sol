...
contract BaseRewardPool4626 is BaseRewardPool, ReentrancyGuard, IERC4626 {
    ...
    constructor(address _operator) public BaseRewardPool(_operator) {}
    ...
    function init(
        ...
        super.init(pid_, stakingToken_, rewardToken_, rewardManager_);
    }
    ...
    function withdraw(
        ...
        if (msg.sender != owner) {
            _approve(
                owner,
                msg.sender,
                _allowances[owner][msg.sender].sub(assets, "ERC4626: withdrawal amount exceeds allowance")
            );
        }
    ...
    function transferFrom(
        ...
        uint256 newAllowance = _allowances[owner][msg.sender].sub(
            amount,
            "ERC4626: withdrawal amount exceeds allowance"
        );
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) internal virtual updateReward(from) updateReward(to) {
